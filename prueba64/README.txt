...
a persistence unit "prueba64PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba64/pom.xml":
...
artifact ("prueba64.war") is already built. You can build
